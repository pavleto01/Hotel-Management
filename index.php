...
<body>
	<br><br>
		<div class = "center">
	<form method="post">
			<label >Search by agent</label>
			<input type="text" name="agent">
			<input type="submit" name="bydate" value = "Search">
			<br><br><input type="submit" name="topfive" value = "Top 5 agents">
			<br><br><input type="submit" name="mostres" value = "Most reserved rooms">
			<br><br><input type="submit" name="all" value = "All reservations">
			</form>	
		</div>
		...
		<thead>
			<tr style="height:50px">
				<th style="text-align:center;width:18%;">Date In</th>
				<th style="text-align:center;width:18%;">Date Out</th>
				<th style="text-align:center;width:19%;">Client</th>
				<th style="text-align:center;width:19%;">Agent</th>
				<th style="text-align:center;width:6%;">Room</th>
		...
		<tbody>
			<tr>
				...
				<?php }
			?> </td>
			<td style="text-align:center; "><a  href="showdetails.php?id=<?php echo $row['id_reservation']; ?>">SHOW</a></td>			
		</tr>
	<?php  }  ?>				 
</tbody>
</table>
...
<?php  
		...
		<thead>
			<tr style="height:50px">
				<th style="text-align:center;">Name of agent</th>
				<th style="text-align:center;">Number of reservations</th>
			</tr>
		</thead>
		<tbody>
			<tr>
...
<?php  
		...
		<thead>
			<tr style="height:50px">
				<th style="text-align:center;width:25%;">Room number</th>
				<th style="text-align:center;width:25%;">Room type</th>
				<th style="text-align:center;width:25%;">Room price</th>
				<th style="text-align:center;width:25%;">Number of reservations</th>
			</tr>
		</thead>
		<tbody>
			<tr>
...
<?php  
		...
		<tbody>
			<tr>
				...
				<?php }
			?> </td>
			<td style="text-align:center; width:10%;"><a  href="showdetails.php?id=<?php echo $row['id_reservation']; ?>">SHOW</a></td>	
			<td style="text-align:center; "><a href="delres.php?delete_id=<?php echo $row['id_reservation']; ?>">DELETE</a></td>		
		</tr>
	<?php  }  ?>				 
</tbody>
</table>
