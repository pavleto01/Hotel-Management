...
<table class="table">
        <thead>
            <tr style="height:50px">
                <th style="text-align:center;background-color: #D6EEEE">Room</th>
                <th style="text-align:center;background-color: #D6EEEE">Client</th>
                <th style="text-align:center;background-color: #D6EEEE">Agent</th>
    ...
    <?php
        ...
        ?>
            <tr>
                ...
                <td style="text-align:center; "><?php echo $row['agent_name']."-".$row['agent_position'] ?></td>
        </tr>  
            <?php } } ?>     
        </tbody>
    </table>
...
<tr>
    <th> 
    <h4>Date IN: <?php echo $row['date_in']; ?>
    <br>
    <form method="POST">
    <input type="datetime-local" id="date_in" name="date_in">
     </h4>
     <input type="submit" name="updatedatein" value="Update date in">
     <br><br>
     </form>
    </th>
</tr>
...
<tr>
    <th> 
    <h4>Date out: <?php echo $row['date_out']; ?>
    <br>
    <form method="POST">
    <input type="datetime-local" id="date_out" name="date_out">
     </h4>
    <input type="submit" name="updatedateout" value="Update date out">
    <br><br>
</form>
    </th>
</tr>
